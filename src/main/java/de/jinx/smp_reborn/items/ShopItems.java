...
public class ShopItems {
    public static ItemStack timberAxeBuy = new ItemBuilder(Material.GOLDEN_AXE).setAmount(1).setName("§3§lBest Friend").setLore("Costs 2 Evil Spirits","Fortune but for Trees!").addEnchantment(SMP_Reboot.timber,1,true).build();
