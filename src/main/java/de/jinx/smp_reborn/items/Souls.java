...
public class Souls {
    ...
    public static ItemStack timberAxe = new ItemBuilder(Material.GOLDEN_AXE).setAmount(1).setName("§3§lBest Friend").setLore("...for Lumberjacks","Timber I").addEnchantment(SMP_Reboot.timber,1,true).build();
}